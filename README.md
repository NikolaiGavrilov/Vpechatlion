# Практический проект для моей дипломной работы на тему "Разработка социальной сети «Впечатлион» с использованием фреймворка React и нейросети Stable Diffusion для создания уникального визуального стиля"
