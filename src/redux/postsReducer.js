...
const initialState = {
    posts: [
        ...
        },
        {
            ...
            description: "Сходили с мужем на мастер-класс рисования. При том, что оба не сильны в рисовании, смогли нарисовать две чудесные картины. Моя картина - с черепахой, картина мужа - с черепахой. Немного нам, конечно, помог художник, но только на финальном этапе. Очень понравилась такая творческая деятельность. Осталось придумать, куда их повесить.",
            likes: 82,
            youLiked: false,
            path: "/posts/24",
